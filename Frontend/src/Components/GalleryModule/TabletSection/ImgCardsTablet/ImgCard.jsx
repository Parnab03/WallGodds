        ...
        <div className={Style.imgCard}>
            <div className={Style.icons}>
                ...
                <svg
                    ...
                    viewBox="0 0 24 24"
                    className={`${Style.icon} ${liked ? Style.liked : ""}`}
                >
                    <path
                ...
                <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    className={`${Style.icon} ${saved ? Style.saved : ""}`}
                >
                    <path
                        d="M6 4C5.44772 4 5 4.44772 5 5V21L12 17L19 21V5
                        C19 4.44772 18.5523 4 18 4H6Z"
                        fill={saved ? "#4d4c4c" : "none"}
                        stroke="currentColor"
                        strokeWidth="2"
                    />
                </svg>
